...
/**
 * The slice of map functionality modes need. Extracted from
 * [BaseMapAdapter] so edit/draw modes and map-bound helpers can be exercised
 * on the JVM against fakes; production delegates to the real adapter.
 */
 ...
 * Map-bound operations go through [mapActions]; [Geoman] itself implements
 * this contract, so passing a concrete instance is also valid.
 */
interface GeomanApi {
    ...
    /** Toggle a mode; returns whether it ended enabled. */
